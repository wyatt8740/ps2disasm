...
; SFX
	...
	dc.b	$00, $70, $70, $40, $78, $50, $50, $50, $50, $50, $50
...
FMInsPtrs:
	...
	dc.w	z80ptr(loc_B8699)
	dc.w	z80ptr(loc_B86CE)
	dc.w	z80ptr(loc_B8703)
	dc.w	z80ptr(loc_B8738)
	dc.w	z80ptr(loc_B876D)
	dc.w	z80ptr(loc_B87A2)
	dc.w	z80ptr(loc_B87D7)
	dc.w	z80ptr(loc_B880C)
	dc.w	z80ptr(loc_B8841)
	dc.w	z80ptr(loc_B88AB)
	dc.w	z80ptr(loc_B88E0)
	dc.w	z80ptr(loc_B8915)
	dc.w	z80ptr(loc_B894A)
	dc.w	z80ptr(loc_B897F)
	dc.w	z80ptr(loc_B89B4)
	dc.w	z80ptr(loc_B89E9)
	dc.w	z80ptr(loc_B8A1E)
	dc.w	z80ptr(loc_B8A53)
	dc.w	z80ptr(loc_B8A88)
	dc.w	z80ptr(loc_B8ABD)
	dc.w	z80ptr(loc_B8AF2)
	dc.w	z80ptr(loc_B8B27)
	dc.w	z80ptr(loc_B8B5C)
	dc.w	z80ptr(loc_B8B91)
	dc.w	z80ptr(loc_B8BC6)
	dc.w	z80ptr(loc_B8BFB)
	dc.w	z80ptr(loc_B8C30)
	dc.w	z80ptr(loc_B8C65)
	dc.w	z80ptr(loc_B8C9A)
	dc.w	z80ptr(loc_B8CCF)
	dc.w	z80ptr(loc_B8D04)
	dc.w	z80ptr(loc_B8D39)
	dc.w	z80ptr(loc_B8D6E)
	dc.w	z80ptr(loc_B8DA3)
	dc.w	z80ptr(loc_B8DD8)
	dc.w	z80ptr(loc_B8E0D)
	dc.w	z80ptr(loc_B8E42)
	dc.w	z80ptr(loc_B8E77)
	dc.w	z80ptr(loc_B8EAC)
	dc.w	z80ptr(loc_B8EE1)
	dc.w	z80ptr(loc_B8F16)
	dc.w	z80ptr(loc_B8F4B)
	dc.w	z80ptr(loc_B8F80)
	dc.w	z80ptr(loc_B8FB5)
	dc.w	z80ptr(loc_B8FEA)
	dc.w	z80ptr(loc_B901F)
	dc.w	z80ptr(loc_B9054)
	dc.w	z80ptr(loc_B9089)
	dc.w	z80ptr(loc_B90BE)
	dc.w	z80ptr(loc_B90F3)
	dc.w	z80ptr(loc_B9128)
	dc.w	z80ptr(loc_B915D)
	dc.w	z80ptr(loc_B9192)
	dc.w	z80ptr(loc_B91C7)
	dc.w	z80ptr(loc_B91C7)
	dc.w	z80ptr(loc_B91C7)
	dc.w	z80ptr(loc_B91C7)
	dc.w	z80ptr(loc_B91C7)
	...
	dc.w	z80ptr(loc_B91C7)
	dc.w	z80ptr(loc_B91C7)
	dc.w	z80ptr(loc_B91FC)
	dc.w	z80ptr(loc_B9231)
	dc.w	z80ptr(loc_B9266)
	dc.w	z80ptr(loc_B929B)
	dc.w	z80ptr(loc_B92D0)
	dc.w	z80ptr(loc_B9305)
	dc.w	z80ptr(loc_B9332)
	dc.w	z80ptr(loc_B9367)
	dc.w	z80ptr(loc_B939C)
	dc.w	z80ptr(loc_B93D1)
	dc.w	z80ptr(loc_B9406)
	dc.w	z80ptr(loc_B943B)
	dc.w	z80ptr(loc_B9470)
	dc.w	z80ptr(loc_B94A5)
	dc.w	z80ptr(loc_B94DA)
	dc.w	z80ptr(loc_B950F)
	dc.w	z80ptr(loc_B9544)
	dc.w	z80ptr(loc_B9579)
	dc.w	z80ptr(loc_B95AE)
	dc.w	z80ptr(loc_B95E3)
	dc.w	z80ptr(loc_B9618)
	dc.w	z80ptr(loc_B964D)
	dc.w	z80ptr(loc_B9682)
	dc.w	z80ptr(loc_B96B7)
	dc.w	z80ptr(loc_B96EC)
	dc.w	z80ptr(loc_B9721)
	dc.w	z80ptr(loc_B9756)
	dc.w	z80ptr(loc_B978B)
	dc.w	z80ptr(loc_B97C0)
	dc.w	z80ptr(loc_B97F5)
	dc.w	z80ptr(loc_B982A)
	dc.w	z80ptr(loc_B985F)
	dc.w	z80ptr(loc_B9894)
	dc.w	z80ptr(loc_B98C9)
	dc.w	z80ptr(loc_B98FE)
	dc.w	z80ptr(loc_B9933)
	dc.w	z80ptr(loc_B9968)
	dc.w	z80ptr(loc_B999D)
	dc.w	z80ptr(loc_B99D2)
	dc.w	z80ptr(loc_B99FF)	
	

loc_B85FA:
	dc.b	$B0, $13, $B4, $C0, $30, $08, $38, $16, $34, $06, $3C, $02, $40, $30, $48, $30
	dc.b	$44, $30, $4C, $00, $50, $10, $58, $1F, $54, $1F, $5C, $1F, $60, $01, $68, $01
	dc.b	$64, $00, $6C, $00, $70, $0B, $78, $00, $74, $05, $7C, $09, $80, $16, $88, $8F
	dc.b	$84, $3F, $8C, $8E, $83
loc_B862F:
	dc.b	$B0, $3C, $B4, $C0, $30, $67, $38, $43, $34, $32, $3C, $72, $40, $1E, $48, $02
	dc.b	$44, $05, $4C, $02, $50, $1F, $58, $1F, $54, $1F, $5C, $1F, $60, $00, $68, $00
	dc.b	$64, $00, $6C, $00, $70, $16, $78, $15, $74, $12, $7C, $14, $80, $11, $88, $13
	dc.b	$84, $15, $8C, $17, $83
loc_B8664:
	dc.b	$B0, $24, $B4, $C0, $30, $06, $38, $04, $34, $0F, $3C, $04, $40, $38, $48, $00
	dc.b	$44, $1A, $4C, $00, $50, $97, $58, $1B, $54, $9F, $5C, $1F, $60, $09, $68, $0D
	dc.b	$64, $00, $6C, $0D, $70, $00, $78, $06, $74, $00, $7C, $00, $80, $23, $88, $AC
	dc.b	$84, $02, $8C, $AE, $83
loc_B8699:
	dc.b	$B0, $F5, $B4, $C0, $40, $01, $48, $00, $44, $00, $4C, $00, $50, $15, $58, $1B
	dc.b	$54, $1F, $5C, $14, $30, $11, $38, $01, $34, $20, $3C, $61, $60, $12, $68, $06
	dc.b	$64, $00, $6C, $00, $70, $04, $78, $0A, $74, $30, $7C, $02, $80, $14, $88, $16
	dc.b	$84, $16, $8C, $46, $83
loc_B86CE:
	dc.b	$B0, $17, $B4, $C0, $30, $44, $38, $42, $34, $53, $3C, $10, $40, $00, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $1A, $58, $9E, $54, $9F, $5C, $5F, $60, $1F, $68, $1F
	dc.b	$64, $1F, $6C, $1B, $70, $13, $78, $12, $74, $93, $7C, $10, $80, $6F, $88, $4F
	dc.b	$84, $8E, $8C, $4E, $83
loc_B8703:
	dc.b	$B0, $04, $B4, $C0, $30, $0C, $38, $0F, $34, $0C, $3C, $08, $40, $60, $48, $00
	dc.b	$44, $60, $4C, $00, $50, $1F, $58, $1F, $54, $1F, $5C, $1F, $60, $00, $68, $00
	dc.b	$64, $00, $6C, $00, $70, $00, $78, $06, $74, $00, $7C, $0E, $80, $0C, $88, $EA
	dc.b	$84, $0B, $8C, $B6, $83
loc_B8738:
	dc.b	$B0, $05, $B4, $C0, $30, $37, $38, $61, $34, $72, $3C, $01, $40, $0E, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $1F, $58, $1F, $54, $1F, $5C, $1E, $60, $00, $68, $02
	dc.b	$64, $15, $6C, $00, $70, $02, $78, $80, $74, $65, $7C, $07, $80, $0C, $88, $0F
	dc.b	$84, $BF, $8C, $0F, $83
loc_B876D:
	dc.b	$B0, $21, $B4, $F6, $30, $B2, $38, $1A, $34, $3B, $3C, $43, $40, $07, $48, $00
	dc.b	$44, $12, $4C, $00, $50, $69, $58, $85, $54, $42, $5C, $0C, $60, $89, $68, $A2
	dc.b	$64, $00, $6C, $0F, $70, $04, $78, $0B, $74, $71, $7C, $10, $80, $4F, $88, $77
	dc.b	$84, $24, $8C, $98, $83
loc_B87A2:
	dc.b	$B0, $14, $B4, $C0, $30, $52, $38, $B1, $34, $41, $3C, $60, $40, $10, $48, $00
	dc.b	$44, $10, $4C, $00, $50, $04, $58, $0C, $54, $16, $5C, $4E, $60, $05, $68, $08
	dc.b	$64, $08, $6C, $00, $70, $0A, $78, $04, $74, $05, $7C, $03, $80, $7C, $88, $79
	dc.b	$84, $0A, $8C, $59, $83
loc_B87D7:
	dc.b	$B0, $97, $B4, $C0, $30, $02, $38, $21, $34, $61, $3C, $36, $40, $10, $48, $03
	dc.b	$44, $03, $4C, $10, $50, $10, $58, $0B, $54, $09, $5C, $10, $60, $02, $68, $01
	dc.b	$64, $80, $6C, $80, $70, $03, $78, $21, $74, $13, $7C, $82, $80, $1C, $88, $4C
	dc.b	$84, $8C, $8C, $5D, $83
loc_B880C:
	dc.b	$B0, $4C, $B4, $C0, $30, $02, $38, $22, $34, $61, $3C, $36, $40, $30, $48, $00
	dc.b	$44, $30, $4C, $00, $50, $1F, $58, $18, $54, $1F, $5C, $16, $60, $00, $68, $02
	dc.b	$64, $00, $6C, $01, $70, $03, $78, $21, $74, $13, $7C, $82, $80, $1C, $88, $4C
	dc.b	$84, $8C, $8C, $5D, $83
loc_B8841:
	dc.b	$B0, $3D, $B4, $C0, $30, $2A, $38, $64, $34, $73, $3C, $40, $40, $12, $48, $00
	dc.b	$44, $0C, $4C, $00, $50, $13, $58, $0A, $54, $0A, $5C, $0A, $60, $1A, $68, $0B
	dc.b	$64, $0C, $6C, $0B, $70, $23, $78, $23, $74, $07, $7C, $0E, $80, $08, $88, $68
	dc.b	$84, $09, $8C, $56, $83, $B0, $3D, $B4, $C0, $40, $0C, $48, $00, $44, $F0, $4C
	dc.b	$00, $50, $1F, $58, $9F, $54, $9F, $5C, $6F, $30, $50, $38, $70, $34, $50, $3C
	dc.b	$10, $60, $1F, $68, $1F, $64, $1F, $6C, $1F, $70, $00, $78, $12, $74, $10, $7C
	dc.b	$0F, $80, $05, $88, $4F, $84, $4F, $8C, $4F, $83
loc_B88AB:
	dc.b	$B0, $3A, $B4, $C0, $40, $00, $48, $00, $44, $00, $4C, $00, $50, $10, $58, $10
	dc.b	$54, $10, $5C, $0F, $30, $71, $38, $51, $34, $62, $3C, $54, $60, $00, $68, $00
	dc.b	$64, $04, $6C, $29, $70, $80, $78, $00, $74, $C1, $7C, $80, $80, $24, $88, $29
	dc.b	$84, $1F, $8C, $78, $83
loc_B88E0:
	dc.b	$B0, $3C, $B4, $C0, $30, $13, $38, $53, $34, $62, $3C, $51, $40, $13, $48, $03
	dc.b	$44, $15, $4C, $03, $50, $14, $58, $11, $54, $1A, $5C, $B5, $60, $04, $68, $04
	dc.b	$64, $04, $6C, $22, $70, $52, $78, $59, $74, $34, $7C, $39, $80, $1F, $88, $8F
	dc.b	$84, $1F, $8C, $8F, $83
loc_B8915:
	dc.b	$B0, $3D, $B4, $C0, $30, $2A, $38, $64, $34, $73, $3C, $40, $40, $12, $48, $00
	dc.b	$44, $0C, $4C, $00, $50, $13, $58, $0A, $54, $0A, $5C, $0A, $60, $1A, $68, $0B
...
loc_B894A:
	...
	dc.b	$84, $09, $8C, $56, $83
loc_B897F:
	dc.b	$B0, $02, $B4, $C0, $30, $71, $38, $82, $34, $70, $3C, $51, $40, $04, $48, $0D
	dc.b	$44, $08, $4C, $03, $50, $1F, $58, $1F, $54, $1F, $5C, $1F, $60, $58, $68, $44
	dc.b	$64, $0D, $6C, $09, $70, $17, $78, $0B, $74, $65, $7C, $07, $80, $07, $88, $17
	dc.b	$84, $08, $8C, $09, $83
loc_B89B4:
	dc.b	$B0, $05, $B4, $C0, $30, $45, $38, $53, $34, $51, $3C, $62, $40, $05, $48, $07
	dc.b	$44, $06, $4C, $04, $50, $03, $58, $0B, $54, $0E, $5C, $09, $60, $06, $68, $09
	dc.b	$64, $08, $6C, $02, $70, $05, $78, $05, $74, $01, $7C, $09, $80, $0F, $88, $0F
	dc.b	$84, $0A, $8C, $0F, $83
loc_B89E9:
	dc.b	$B0, $1B, $B4, $C0, $30, $6C, $38, $4F, $34, $0A, $3C, $8E, $40, $05, $48, $05
	dc.b	$44, $1A, $4C, $00, $50, $1F, $58, $1C, $54, $18, $5C, $1F, $60, $19, $68, $10
	dc.b	$64, $1A, $6C, $00, $70, $0E, $78, $30, $74, $40, $7C, $00, $80, $36, $88, $F4
	dc.b	$84, $A4, $8C, $1A, $83
loc_B8A1E:
	dc.b	$B0, $00, $B4, $C0, $30, $91, $38, $35, $34, $30, $3C, $00, $40, $01, $48, $01
	dc.b	$44, $00, $4C, $00, $50, $0F, $58, $9F, $54, $C9, $5C, $1F, $60, $48, $68, $3A
	dc.b	$64, $08, $6C, $08, $70, $65, $78, $20, $74, $80, $7C, $02, $80, $F4, $88, $6D
	dc.b	$84, $3E, $8C, $4B, $83
loc_B8A53:
	dc.b	$B0, $02, $B4, $C0, $30, $03, $38, $02, $34, $02, $3C, $02, $40, $24, $48, $08
	dc.b	$44, $07, $4C, $03, $50, $1F, $58, $1F, $54, $1F, $5C, $1F, $60, $14, $68, $14
	dc.b	$64, $0D, $6C, $19, $70, $19, $78, $0A, $74, $15, $7C, $08, $80, $1A, $88, $1F
	dc.b	$84, $1F, $8C, $0F, $83
loc_B8A88:
	dc.b	$B0, $3B, $B4, $C0, $30, $15, $38, $30, $34, $32, $3C, $41, $40, $10, $48, $20
	dc.b	$44, $10, $4C, $00, $50, $1F, $58, $1C, $54, $18, $5C, $0F, $60, $09, $68, $20
	dc.b	$64, $0A, $6C, $0F, $70, $04, $78, $00, $74, $00, $7C, $11, $80, $08, $88, $F4
	dc.b	$84, $A4, $8C, $17, $83
loc_B8ABD:
	dc.b	$B0, $1D, $B4, $C0, $30, $54, $38, $44, $34, $64, $3C, $11, $40, $0D, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $15, $58, $1F, $54, $57, $5C, $5C, $60, $06, $68, $05
	dc.b	$64, $0C, $6C, $01, $70, $86, $78, $05, $74, $0C, $7C, $01, $80, $68, $88, $1A
	dc.b	$84, $5C, $8C, $88, $83
loc_B8AF2:
	dc.b	$B0, $05, $B4, $C0, $30, $24, $38, $71, $34, $50, $3C, $40, $40, $18, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $1F, $58, $1F, $54, $1C, $5C, $13, $60, $04, $68, $0B
	dc.b	$64, $1C, $6C, $0B, $70, $04, $78, $82, $74, $0E, $7C, $1E, $80, $9F, $88, $6F
	dc.b	$84, $26, $8C, $5E, $83
loc_B8B27:
	dc.b	$B0, $05, $B4, $C0, $30, $23, $38, $27, $34, $50, $3C, $41, $40, $18, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $15, $58, $1F, $54, $1C, $5C, $0B, $60, $04, $68, $0B
	dc.b	$64, $1C, $6C, $0B, $70, $04, $78, $82, $74, $0E, $7C, $1E, $80, $9F, $88, $6F
	dc.b	$84, $2E, $8C, $5E, $83
loc_B8B5C:
	dc.b	$B0, $1D, $B4, $C0, $30, $63, $38, $30, $34, $33, $3C, $60, $40, $09, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $10, $58, $1F, $54, $1F, $5C, $1F, $60, $08, $68, $0E
	dc.b	$64, $12, $6C, $10, $70, $04, $78, $08, $74, $0A, $7C, $0E, $80, $1E, $88, $1F
	dc.b	$84, $1B, $8C, $1F, $83
loc_B8B91:
	dc.b	$B0, $03, $B4, $C0, $30, $23, $38, $63, $34, $73, $3C, $70, $40, $10, $48, $20
	dc.b	$44, $0C, $4C, $00, $50, $1F, $58, $1F, $54, $1F, $5C, $1F, $60, $0F, $68, $01
	dc.b	$64, $00, $6C, $03, $70, $08, $78, $09, $74, $08, $7C, $0C, $80, $58, $88, $3E
	dc.b	$84, $33, $8C, $48, $83
loc_B8BC6:
	dc.b	$B0, $39, $B4, $C0, $30, $1B, $38, $30, $34, $31, $3C, $40, $40, $18, $48, $10
	dc.b	$44, $08, $4C, $00, $50, $D3, $58, $D3, $54, $D4, $5C, $0E, $60, $09, $68, $00
	dc.b	$64, $00, $6C, $17, $70, $2C, $78, $40, $74, $62, $7C, $26, $80, $04, $88, $15
	dc.b	$84, $64, $8C, $07, $83
loc_B8BFB:
	dc.b	$B0, $05, $B4, $C0, $30, $63, $38, $30, $34, $AC, $3C, $42, $40, $30, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $08, $58, $0C, $54, $0D, $5C, $0E, $60, $0A, $68, $00
	dc.b	$64, $05, $6C, $00, $70, $09, $78, $04, $74, $04, $7C, $07, $80, $4A, $88, $6A
	dc.b	$84, $7A, $8C, $6C, $83
loc_B8C30:
	dc.b	$B0, $1D, $B4, $C0, $30, $66, $38, $32, $34, $30, $3C, $60, $40, $10, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $10, $58, $1F, $54, $1F, $5C, $1F, $60, $08, $68, $0E
	dc.b	$64, $12, $6C, $10, $70, $04, $78, $08, $74, $0A, $7C, $0C, $80, $1E, $88, $1E
	dc.b	$84, $1E, $8C, $1E, $83
loc_B8C65:
	dc.b	$B0, $3D, $B4, $C0, $30, $24, $38, $48, $34, $55, $3C, $40, $40, $12, $48, $00
	dc.b	$44, $0C, $4C, $00, $50, $15, $58, $0A, $54, $0C, $5C, $12, $60, $1A, $68, $1B
	dc.b	$64, $1C, $6C, $0B, $70, $04, $78, $1A, $74, $17, $7C, $1E, $80, $0F, $88, $1F
	dc.b	$84, $3F, $8C, $5F, $83
loc_B8C9A:
	dc.b	$B0, $3D, $B4, $C0, $30, $75, $38, $40, $34, $57, $3C, $43, $40, $10, $48, $02
	dc.b	$44, $1C, $4C, $05, $50, $15, $58, $0A, $54, $0C, $5C, $11, $60, $1A, $68, $1B
	dc.b	$64, $2C, $6C, $0B, $70, $06, $78, $2A, $74, $27, $7C, $1E, $80, $0E, $88, $28
	dc.b	$84, $38, $8C, $5E, $83
loc_B8CCF:
	dc.b	$B0, $3C, $B4, $C0, $30, $71, $38, $90, $34, $50, $3C, $72, $40, $02, $48, $00
	dc.b	$44, $1F, $4C, $05, $50, $10, $58, $1F, $54, $10, $5C, $1F, $60, $0D, $68, $04
	dc.b	$64, $44, $6C, $49, $70, $88, $78, $58, $74, $08, $7C, $24, $80, $44, $88, $38
	dc.b	$84, $46, $8C, $E9, $83
loc_B8D04:
	dc.b	$B0, $34, $B4, $C0, $30, $70, $38, $90, $34, $51, $3C, $A0, $40, $04, $48, $00
	dc.b	$44, $02, $4C, $05, $50, $10, $58, $1A, $54, $10, $5C, $19, $60, $04, $68, $06
	dc.b	$64, $F4, $6C, $1F, $70, $31, $78, $28, $74, $08, $7C, $2C, $80, $74, $88, $5B
	dc.b	$84, $26, $8C, $1A, $83
loc_B8D39:
	dc.b	$B0, $24, $B4, $C0, $40, $1D, $48, $07, $44, $20, $4C, $07, $50, $1F, $58, $58
	dc.b	$54, $1F, $5C, $1F, $30, $3F, $38, $54, $34, $67, $3C, $74, $60, $13, $68, $08
	dc.b	$64, $0E, $6C, $08, $70, $04, $78, $05, $74, $05, $7C, $05, $80, $55, $88, $17
	dc.b	$84, $62, $8C, $17, $83
loc_B8D6E:
	dc.b	$B0, $3C, $B4, $C0, $30, $65, $38, $43, $34, $36, $3C, $78, $40, $20, $48, $04
	dc.b	$44, $00, $4C, $00, $50, $1F, $58, $0E, $54, $1F, $5C, $0E, $60, $10, $68, $00
	dc.b	$64, $00, $6C, $00, $70, $16, $78, $15, $74, $12, $7C, $12, $80, $14, $88, $13
	dc.b	$84, $15, $8C, $12, $83
loc_B8DA3:
	dc.b	$B0, $34, $B4, $C0, $30, $70, $38, $7F, $34, $31, $3C, $5F, $40, $03, $48, $00
	dc.b	$44, $00, $4C, $03, $50, $19, $58, $0F, $54, $72, $5C, $0B, $60, $14, $68, $01
	dc.b	$64, $01, $6C, $58, $70, $43, $78, $01, $74, $00, $7C, $04, $80, $20, $88, $26
	dc.b	$84, $F4, $8C, $C4, $83
loc_B8DD8:
	dc.b	$B0, $3B, $B4, $C0, $40, $0F, $48, $13, $44, $0F, $4C, $00, $50, $1F, $58, $0F
	dc.b	$54, $13, $5C, $17, $30, $05, $38, $0B, $34, $00, $3C, $02, $60, $02, $68, $02
	dc.b	$64, $06, $6C, $02, $70, $0F, $78, $0A, $74, $0C, $7C, $09, $80, $24, $88, $26
	dc.b	$84, $26, $8C, $89, $83
loc_B8E0D:
	dc.b	$B0, $34, $B4, $C0, $30, $60, $38, $51, $34, $20, $3C, $10, $40, $14, $48, $13
	dc.b	$44, $0A, $4C, $00, $50, $1F, $58, $95, $54, $9C, $5C, $54, $60, $01, $68, $02
	dc.b	$64, $0E, $6C, $04, $70, $00, $78, $01, $74, $00, $7C, $01, $80, $34, $88, $07
	dc.b	$84, $D8, $8C, $17, $83
loc_B8E42:
	dc.b	$B0, $03, $B4, $C0, $30, $17, $38, $1F, $34, $70, $3C, $71, $40, $10, $48, $18
	dc.b	$44, $10, $4C, $00, $50, $1F, $58, $18, $54, $18, $5C, $1F, $60, $01, $68, $05
	dc.b	$64, $03, $6C, $00, $70, $00, $78, $03, $74, $00, $7C, $00, $80, $03, $88, $16
	dc.b	$84, $04, $8C, $19, $83
loc_B8E77:
	dc.b	$B0, $03, $B4, $C0, $30, $20, $38, $20, $34, $75, $3C, $72, $40, $28, $48, $16
	dc.b	$44, $15, $4C, $00, $50, $1F, $58, $08, $54, $1F, $5C, $1F, $60, $0F, $68, $02
	dc.b	$64, $0A, $6C, $06, $70, $00, $78, $01, $74, $00, $7C, $0C, $80, $01, $88, $16
	dc.b	$84, $02, $8C, $17, $83
loc_B8EAC:
	dc.b	$B0, $22, $B4, $C0, $30, $18, $38, $3F, $34, $38, $3C, $06, $40, $28, $48, $2E
	dc.b	$44, $16, $4C, $00, $50, $15, $58, $0E, $54, $8C, $5C, $8B, $60, $02, $68, $00
	dc.b	$64, $00, $6C, $0E, $70, $01, $78, $00, $74, $00, $7C, $06, $80, $46, $88, $65
	dc.b	$84, $F8, $8C, $08, $83
loc_B8EE1:
	dc.b	$B0, $3B, $B4, $C0, $30, $71, $38, $00, $34, $02, $3C, $31, $40, $12, $48, $00
	dc.b	$44, $10, $4C, $00, $50, $1F, $58, $0E, $54, $1F, $5C, $1F, $60, $05, $68, $01
	dc.b	$64, $01, $6C, $01, $70, $00, $78, $02, $74, $01, $7C, $03, $80, $06, $88, $1A
	dc.b	$84, $0A, $8C, $49, $83
loc_B8F16:
	dc.b	$B0, $1C, $B4, $C0, $30, $65, $38, $72, $34, $79, $3C, $10, $40, $20, $48, $00
	dc.b	$44, $18, $4C, $00, $50, $15, $58, $9B, $54, $9B, $5C, $5F, $60, $04, $68, $02
	dc.b	$64, $0A, $6C, $04, $70, $06, $78, $01, $74, $06, $7C, $04, $80, $68, $88, $58
	dc.b	$84, $88, $8C, $87, $83
loc_B8F4B:
	dc.b	$B0, $1A, $B4, $C0, $30, $16, $38, $32, $34, $38, $3C, $19, $40, $10, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $55, $58, $9E, $54, $9C, $5C, $1F, $60, $03, $68, $09
	dc.b	$64, $04, $6C, $08, $70, $04, $78, $03, $74, $02, $7C, $06, $80, $59, $88, $2A
	dc.b	$84, $35, $8C, $3A, $83
loc_B8F80:
	dc.b	$B0, $19, $B4, $C0, $30, $31, $38, $3B, $34, $77, $3C, $17, $40, $20, $48, $20
	dc.b	$44, $10, $4C, $00, $50, $1F, $58, $13, $54, $1F, $5C, $1F, $60, $0E, $68, $05
	dc.b	$64, $00, $6C, $00, $70, $16, $78, $04, $74, $01, $7C, $00, $80, $8A, $88, $28
	dc.b	$84, $8E, $8C, $EB, $83
loc_B8FB5:
	dc.b	$B0, $1C, $B4, $C0, $30, $66, $38, $7F, $34, $72, $3C, $16, $40, $00, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $07, $58, $0F, $54, $45, $5C, $0F, $60, $04, $68, $01
	dc.b	$64, $04, $6C, $00, $70, $00, $78, $04, $74, $0F, $7C, $04, $80, $2F, $88, $2F
	dc.b	$84, $2F, $8C, $2F, $83
loc_B8FEA:
	dc.b	$40, $1D, $48, $17, $44, $0D, $4C, $00, $50, $1F, $58, $0E, $54, $1A, $5C, $1F
	dc.b	$30, $03, $38, $01, $34, $00, $3C, $00, $60, $04, $68, $00, $64, $04, $6C, $06
	dc.b	$70, $02, $78, $02, $74, $02, $7C, $02, $80, $28, $88, $27, $84, $27, $8C, $33
	dc.b	$B0, $38, $B4, $C0, $83
loc_B901F:
	dc.b	$B0, $18, $B4, $C0, $40, $10, $48, $18, $44, $0F, $4C, $06, $50, $1B, $58, $1F
	dc.b	$54, $1F, $5C, $1F, $30, $01, $38, $00, $34, $00, $3C, $00, $60, $04, $68, $04
	dc.b	$64, $04, $6C, $06, $70, $08, $78, $08, $74, $08, $7C, $0C, $80, $24, $88, $26
	dc.b	$84, $26, $8C, $24, $83
loc_B9054:
	dc.b	$B0, $1C, $B4, $C0, $30, $70, $38, $75, $34, $70, $3C, $1E, $40, $16, $48, $09
	dc.b	$44, $08, $4C, $00, $50, $04, $58, $0E, $54, $5A, $5C, $15, $60, $08, $68, $02
	dc.b	$64, $01, $6C, $08, $70, $00, $78, $01, $74, $00, $7C, $04, $80, $28, $88, $7B
	dc.b	$84, $F6, $8C, $2A, $83
loc_B9089:
	dc.b	$B0, $34, $B4, $C0, $30, $35, $38, $76, $34, $20, $3C, $56, $40, $07, $48, $0C
	dc.b	$44, $03, $4C, $0D, $50, $14, $58, $0C, $54, $0D, $5C, $11, $60, $08, $68, $04
	dc.b	$64, $07, $6C, $03, $70, $00, $78, $09, $74, $00, $7C, $02, $80, $4B, $88, $1F
	dc.b	$84, $1F, $8C, $7F, $83
loc_B90BE:
	dc.b	$B0, $1D, $B4, $C0, $30, $32, $38, $63, $34, $32, $3C, $34, $40, $0C, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $0A, $58, $18, $54, $18, $5C, $0E, $60, $00, $68, $0A
	dc.b	$64, $0A, $6C, $0A, $70, $08, $78, $01, $74, $02, $7C, $04, $80, $1C, $88, $64
	dc.b	$84, $48, $8C, $68, $83
loc_B90F3:
	dc.b	$B0, $39, $B4, $C0, $30, $32, $38, $00, $34, $01, $3C, $30, $40, $12, $48, $24
	dc.b	$44, $0F, $4C, $00, $50, $10, $58, $10, $54, $10, $5C, $18, $60, $06, $68, $02
	dc.b	$64, $06, $6C, $02, $70, $08, $78, $05, $74, $01, $7C, $01, $80, $B9, $88, $67
	dc.b	$84, $44, $8C, $46, $83
loc_B9128:
	dc.b	$B0, $34, $B4, $C0, $30, $70, $38, $7F, $34, $31, $3C, $5F, $40, $03, $48, $00
	dc.b	$44, $00, $4C, $03, $50, $19, $58, $0F, $54, $52, $5C, $0B, $60, $25, $68, $01
	dc.b	$64, $01, $6C, $58, $70, $43, $78, $01, $74, $00, $7C, $04, $80, $20, $88, $29
	dc.b	$84, $F4, $8C, $CA, $83
loc_B915D:
	dc.b	$30, $01, $38, $03, $34, $01, $3C, $51, $40, $2A, $48, $16, $44, $44, $4C, $00
	dc.b	$50, $0F, $58, $9F, $54, $0F, $5C, $13, $60, $1F, $68, $0E, $64, $1F, $6C, $1F
	dc.b	$70, $00, $78, $00, $74, $00, $7C, $00, $80, $08, $88, $F8, $84, $08, $8C, $08
	dc.b	$B0, $3A, $B4, $C0, $83
loc_B9192:
	dc.b	$B0, $24, $B4, $C0, $30, $04, $38, $02, $34, $04, $3C, $04, $40, $15, $48, $00
	dc.b	$44, $23, $4C, $00, $50, $1F, $58, $1F, $54, $1F, $5C, $1F, $60, $00, $68, $00
	dc.b	$64, $00, $6C, $0D, $70, $00, $78, $00, $74, $00, $7C, $00, $80, $03, $88, $05
	dc.b	$84, $02, $8C, $06, $83
loc_B91C7:
	dc.b	$B0, $1F, $B4, $C0, $30, $73, $38, $72, $34, $11, $3C, $71, $40, $00, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $1F, $58, $1F, $54, $1F, $5C, $1F, $60, $0D, $68, $1F
	dc.b	$64, $1F, $6C, $1F, $70, $01, $78, $01, $74, $01, $7C, $01, $80, $FB, $88, $0A
	dc.b	$84, $0A, $8C, $0A, $83
loc_B91FC:
	dc.b	$B0, $04, $B4, $C0, $30, $03, $38, $00, $34, $41, $3C, $40, $40, $20, $48, $00
	dc.b	$44, $20, $4C, $00, $50, $1C, $58, $17, $54, $1C, $5C, $17, $60, $1B, $68, $0D
	dc.b	$64, $17, $6C, $05, $70, $F0, $78, $01, $74, $80, $7C, $85, $80, $F3, $88, $0A
	dc.b	$84, $5A, $8C, $5A, $83
loc_B9231:
	dc.b	$B0, $04, $B4, $C0, $30, $02, $38, $01, $34, $41, $3C, $01, $40, $08, $48, $08
	dc.b	$44, $10, $4C, $00, $50, $1F, $58, $1F, $54, $24, $5C, $49, $60, $1F, $68, $45
	dc.b	$64, $03, $6C, $00, $70, $0C, $78, $0B, $74, $01, $7C, $0F, $80, $19, $88, $48
	dc.b	$84, $8B, $8C, $E8, $83
loc_B9266:
	dc.b	$B0, $33, $B4, $C0, $30, $22, $38, $06, $34, $02, $3C, $04, $40, $10, $48, $20
	dc.b	$44, $20, $4C, $00, $50, $88, $58, $3C, $54, $5F, $5C, $1F, $60, $01, $68, $08
	dc.b	$64, $1F, $6C, $0F, $70, $03, $78, $08, $74, $04, $7C, $00, $80, $65, $88, $68
	dc.b	$84, $05, $8C, $08, $83
loc_B929B:
	dc.b	$B0, $21, $B4, $C0, $30, $01, $38, $01, $34, $71, $3C, $31, $40, $20, $48, $30
	dc.b	$44, $28, $4C, $00, $50, $1F, $58, $14, $54, $14, $5C, $10, $60, $02, $68, $03
	dc.b	$64, $04, $6C, $04, $70, $04, $78, $02, $74, $02, $7C, $03, $80, $20, $88, $20
	dc.b	$84, $20, $8C, $27, $83
loc_B92D0:
	dc.b	$B0, $1F, $B4, $C0, $30, $33, $38, $31, $34, $73, $3C, $31, $40, $20, $48, $08
	dc.b	$44, $28, $4C, $00, $50, $9F, $58, $1C, $54, $9F, $5C, $9F, $60, $0B, $68, $1C
	dc.b	$64, $10, $6C, $10, $70, $05, $78, $00, $74, $00, $7C, $00, $80, $97, $88, $04
	dc.b	$84, $0C, $8C, $04, $83
loc_B9305:
	dc.b	$B0, $07, $B4, $C0, $30, $02, $38, $39, $34, $31, $3C, $60, $40, $00, $48, $0A
	dc.b	$44, $00, $4C, $00, $50, $05, $58, $C5, $54, $88, $5C, $8C, $60, $03, $68, $00
	dc.b	$64, $05, $6C, $00, $80, $07, $88, $05, $84, $26, $8C, $06, $83
loc_B9332:
	dc.b	$B0, $27, $B4, $C0, $30, $02, $38, $00, $34, $71, $3C, $31, $40, $10, $48, $15
	dc.b	$44, $10, $4C, $10, $50, $12, $58, $12, $54, $12, $5C, $12, $60, $00, $68, $00
	dc.b	$64, $00, $6C, $00, $70, $00, $78, $00, $74, $00, $7C, $00, $80, $06, $88, $06
	dc.b	$84, $05, $8C, $05, $83
loc_B9367:
	dc.b	$B0, $3C, $B4, $C0, $30, $30, $38, $01, $34, $0F, $3C, $04, $40, $38, $48, $00
	dc.b	$44, $1D, $4C, $00, $50, $8D, $58, $52, $54, $9F, $5C, $1F, $60, $09, $68, $00
	dc.b	$64, $00, $6C, $0D, $70, $00, $78, $00, $74, $00, $7C, $00, $80, $23, $88, $08
	dc.b	$84, $02, $8C, $F6, $83
loc_B939C:
	dc.b	$B0, $39, $B4, $C0, $30, $01, $38, $51, $34, $00, $3C, $00, $40, $1C, $48, $22
	dc.b	$44, $1F, $4C, $00, $50, $1F, $58, $5F, $54, $5F, $5C, $5F, $60, $10, $68, $11
	dc.b	$64, $09, $6C, $09, $70, $07, $78, $00, $74, $00, $7C, $00, $80, $C8, $88, $F8
	dc.b	$84, $F8, $8C, $F8, $83
loc_B93D1:
	dc.b	$B0, $28, $B4, $C0, $30, $39, $38, $53, $34, $02, $3C, $12, $40, $17, $48, $32
	dc.b	$44, $14, $4C, $00, $50, $DF, $58, $DF, $54, $81, $5C, $9F, $60, $0C, $68, $07
	dc.b	$64, $0A, $6C, $0A, $70, $07, $78, $07, $74, $07, $7C, $09, $80, $29, $88, $19
	dc.b	$84, $19, $8C, $F9, $83
loc_B9406:
	dc.b	$B0, $3C, $B4, $C0, $30, $32, $38, $71, $34, $3F, $3C, $71, $40, $28, $48, $08
	dc.b	$44, $39, $4C, $00, $50, $4F, $58, $55, $54, $96, $5C, $9B, $60, $03, $68, $01
	dc.b	$64, $0C, $6C, $04, $70, $01, $78, $01, $74, $08, $7C, $01, $80, $17, $88, $15
	dc.b	$84, $44, $8C, $55, $83
loc_B943B:
	dc.b	$B0, $38, $B4, $C0, $30, $01, $38, $03, $34, $53, $3C, $00, $40, $20, $48, $20
	dc.b	$44, $20, $4C, $00, $50, $1B, $58, $1F, $54, $1F, $5C, $1F, $60, $14, $68, $14
	dc.b	$64, $14, $6C, $14, $70, $00, $78, $00, $74, $00, $7C, $07, $80, $F3, $88, $F3
	dc.b	$84, $F3, $8C, $8A, $83
loc_B9470:
	dc.b	$B0, $16, $B4, $C0, $30, $51, $38, $C1, $34, $41, $3C, $42, $40, $50, $48, $00
	dc.b	$44, $08, $4C, $00, $50, $5F, $58, $5A, $54, $58, $5C, $0F, $60, $07, $68, $05
	dc.b	$64, $07, $6C, $04, $70, $06, $78, $02, $74, $03, $7C, $09, $80, $E6, $88, $49
	dc.b	$84, $69, $8C, $39, $83
loc_B94A5:
	dc.b	$B0, $3C, $B4, $C0, $30, $44, $38, $42, $34, $61, $3C, $01, $40, $10, $48, $00
	dc.b	$44, $10, $4C, $00, $50, $10, $58, $5F, $54, $18, $5C, $1F, $60, $0F, $68, $0A
	dc.b	$64, $14, $6C, $10, $70, $05, $78, $0D, $74, $11, $7C, $0F, $80, $87, $88, $CC
	dc.b	$84, $47, $8C, $68, $83
loc_B94DA:
	dc.b	$B0, $32, $B4, $C0, $30, $12, $38, $17, $34, $13, $3C, $11, $40, $26, $48, $24
	dc.b	$44, $20, $4C, $00, $50, $1B, $58, $15, $54, $1A, $5C, $16, $60, $02, $68, $0A
	dc.b	$64, $04, $6C, $0E, $70, $06, $78, $04, $74, $05, $7C, $07, $80, $16, $88, $24
	dc.b	$84, $F5, $8C, $71, $83
loc_B950F:
	dc.b	$B0, $3D, $B4, $C0, $30, $01, $38, $02, $34, $02, $3C, $02, $40, $1F, $48, $12
	dc.b	$44, $27, $4C, $04, $50, $14, $58, $1F, $54, $59, $5C, $1E, $60, $08, $68, $0E
	dc.b	$64, $08, $6C, $0B, $70, $00, $78, $09, $74, $09, $7C, $09, $80, $12, $88, $47
	dc.b	$84, $47, $8C, $47, $83
loc_B9544:
	dc.b	$B0, $3D, $B4, $C0, $30, $02, $38, $01, $34, $02, $3C, $02, $40, $1F, $48, $08
	dc.b	$44, $08, $4C, $07, $50, $1F, $58, $08, $54, $8A, $5C, $0A, $60, $08, $68, $08
	dc.b	$64, $08, $6C, $08, $70, $00, $78, $01, $74, $00, $7C, $00, $80, $02, $88, $16
	dc.b	$84, $17, $8C, $16, $83
loc_B9579:
	dc.b	$B0, $3C, $B4, $C0, $30, $01, $38, $02, $34, $01, $3C, $02, $40, $1E, $48, $00
	dc.b	$44, $1F, $4C, $00, $50, $CF, $58, $0F, $54, $CF, $5C, $0F, $60, $00, $68, $07
	dc.b	$64, $00, $6C, $08, $70, $00, $78, $03, $74, $00, $7C, $00, $80, $02, $88, $37
	dc.b	$84, $02, $8C, $38, $83
loc_B95AE:
	dc.b	$B0, $3A, $B4, $C0, $30, $50, $38, $60, $34, $30, $3C, $00, $40, $18, $48, $1F
	dc.b	$44, $17, $4C, $00, $50, $9F, $58, $89, $54, $5B, $5C, $4B, $60, $09, $68, $09
	dc.b	$64, $1F, $6C, $03, $70, $00, $78, $00, $74, $00, $7C, $00, $80, $13, $88, $F5
	dc.b	$84, $06, $8C, $06, $83
loc_B95E3:
	dc.b	$B0, $03, $B4, $C0, $30, $18, $38, $71, $34, $01, $3C, $01, $40, $12, $48, $16
	dc.b	$44, $1C, $4C, $00, $50, $9B, $58, $DF, $54, $5F, $5C, $4E, $60, $0C, $68, $12
	dc.b	$64, $0B, $6C, $08, $70, $00, $78, $01, $74, $0B, $7C, $0D, $80, $C7, $88, $26
	dc.b	$84, $20, $8C, $F7, $83
loc_B9618:
	dc.b	$B0, $3E, $B4, $C0, $30, $70, $38, $42, $34, $81, $3C, $61, $40, $40, $48, $00
	dc.b	$44, $00, $4C, $08, $50, $1F, $58, $1F, $54, $16, $5C, $18, $60, $13, $68, $08
	dc.b	$64, $09, $6C, $0A, $70, $07, $78, $0A, $74, $03, $7C, $05, $80, $87, $88, $87
	dc.b	$84, $48, $8C, $48, $83
loc_B964D:
	dc.b	$B0, $04, $B4, $C0, $30, $22, $38, $26, $34, $62, $3C, $04, $40, $00, $48, $00
	dc.b	$44, $1C, $4C, $00, $50, $1F, $58, $1F, $54, $1F, $5C, $1F, $60, $09, $68, $0D
	dc.b	$64, $0D, $6C, $0D, $70, $05, $78, $09, $74, $11, $7C, $11, $80, $AA, $88, $59
	dc.b	$84, $98, $8C, $B8, $83
loc_B9682:
	dc.b	$B0, $0C, $B4, $C0, $30, $58, $38, $02, $34, $20, $3C, $01, $40, $18, $48, $10
	dc.b	$44, $21, $4C, $00, $50, $1F, $58, $1F, $54, $05, $5C, $1F, $60, $0A, $68, $0B
	dc.b	$64, $04, $6C, $02, $70, $01, $78, $04, $74, $00, $7C, $00, $80, $52, $88, $62
	dc.b	$84, $56, $8C, $96, $83
loc_B96B7:
	dc.b	$B0, $0C, $B4, $C0, $30, $58, $38, $02, $34, $20, $3C, $01, $40, $18, $48, $08
	dc.b	$44, $21, $4C, $00, $50, $1F, $58, $1F, $54, $05, $5C, $1F, $60, $0A, $68, $0B
	dc.b	$64, $04, $6C, $06, $70, $01, $78, $04, $74, $00, $7C, $00, $80, $52, $88, $62
	dc.b	$84, $56, $8C, $66, $83
loc_B96EC:
	dc.b	$B0, $3C, $B4, $C0, $30, $21, $38, $51, $34, $31, $3C, $21, $40, $1C, $48, $05
	dc.b	$44, $22, $4C, $00, $50, $59, $58, $4A, $54, $59, $5C, $4A, $60, $03, $68, $05
	dc.b	$64, $03, $6C, $05, $70, $00, $78, $00, $74, $00, $7C, $00, $80, $22, $88, $27
	dc.b	$84, $22, $8C, $27, $83
loc_B9721:
	dc.b	$B0, $3C, $B4, $C0, $30, $21, $38, $51, $34, $31, $3C, $21, $40, $1C, $48, $05
	dc.b	$44, $28, $4C, $00, $50, $59, $58, $4A, $54, $59, $5C, $4A, $60, $03, $68, $05
	dc.b	$64, $03, $6C, $05, $70, $00, $78, $00, $74, $00, $7C, $00, $80, $22, $88, $27
	dc.b	$84, $22, $8C, $27, $83
loc_B9756:
	dc.b	$B0, $20, $B4, $C0, $30, $36, $38, $35, $34, $30, $3C, $31, $40, $30, $48, $37
	dc.b	$44, $20, $4C, $00, $50, $DF, $58, $DF, $54, $9F, $5C, $9F, $60, $07, $68, $06
	dc.b	$64, $09, $6C, $06, $70, $07, $78, $06, $74, $06, $7C, $08, $80, $29, $88, $19
	dc.b	$84, $19, $8C, $F9, $83
loc_B978B:
	dc.b	$B0, $38, $B4, $C0, $30, $31, $38, $51, $34, $31, $3C, $71, $40, $20, $48, $11
	dc.b	$44, $21, $4C, $00, $50, $17, $58, $18, $54, $1A, $5C, $1F, $60, $17, $68, $16
	dc.b	$64, $0B, $6C, $07, $70, $00, $78, $00, $74, $00, $7C, $00, $80, $10, $88, $10
	dc.b	$84, $00, $8C, $36, $83
loc_B97C0:
	dc.b	$B0, $3C, $B4, $C0, $30, $28, $38, $51, $34, $54, $3C, $32, $40, $20, $48, $00
	dc.b	$44, $20, $4C, $00, $50, $13, $58, $1E, $54, $1F, $5C, $0C, $60, $0F, $68, $02
	dc.b	$64, $1F, $6C, $00, $70, $00, $78, $00, $74, $00, $7C, $00, $80, $21, $88, $06
	dc.b	$84, $01, $8C, $05, $83
loc_B97F5:
	dc.b	$B0, $3C, $B4, $C0, $30, $34, $38, $52, $34, $52, $3C, $32, $40, $20, $48, $00
	dc.b	$44, $30, $4C, $00, $50, $1F, $58, $1F, $54, $1F, $5C, $1F, $60, $10, $68, $10
	dc.b	$64, $17, $6C, $0C, $70, $01, $78, $03, $74, $07, $7C, $0A, $80, $12, $88, $26
	dc.b	$84, $62, $8C, $66, $83
loc_B982A:
	dc.b	$B0, $50, $B4, $C0, $30, $1A, $38, $34, $34, $30, $3C, $30, $40, $20, $48, $20
	dc.b	$44, $20, $4C, $00, $50, $1E, $58, $19, $54, $1C, $5C, $1D, $60, $1E, $68, $1F
	dc.b	$64, $04, $6C, $08, $70, $03, $78, $03, $74, $03, $7C, $05, $80, $46, $88, $56
	dc.b	$84, $66, $8C, $76, $83
loc_B985F:
	dc.b	$B0, $6D, $B4, $C0, $30, $72, $38, $79, $34, $A2, $3C, $81, $40, $20, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $10, $58, $1A, $54, $59, $5C, $17, $60, $02, $68, $10
	dc.b	$64, $01, $6C, $0A, $70, $03, $78, $18, $74, $02, $7C, $05, $80, $17, $88, $7A
	dc.b	$84, $8A, $8C, $2A, $83
loc_B9894:
	dc.b	$B0, $55, $B4, $C0, $30, $81, $38, $22, $34, $51, $3C, $52, $40, $10, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $19, $58, $1F, $54, $1F, $5C, $1F, $60, $00, $68, $10
	dc.b	$64, $07, $6C, $07, $70, $00, $78, $06, $74, $0B, $7C, $0B, $80, $85, $88, $B3
	dc.b	$84, $86, $8C, $A6, $83
loc_B98C9:
	dc.b	$B0, $22, $B4, $C0, $30, $03, $38, $02, $34, $01, $3C, $01, $40, $10, $48, $10
	dc.b	$44, $20, $4C, $00, $50, $1F, $58, $1F, $54, $1F, $5C, $1F, $60, $17, $68, $16
	dc.b	$64, $0B, $6C, $0F, $70, $10, $78, $10, $74, $10, $7C, $05, $80, $28, $88, $3A
	dc.b	$84, $3A, $8C, $47, $83
loc_B98FE:
	dc.b	$B0, $3C, $B4, $C0, $30, $33, $38, $30, $34, $51, $3C, $00, $40, $28, $48, $00
	dc.b	$44, $14, $4C, $00, $50, $0F, $58, $0B, $54, $0F, $5C, $0B, $60, $04, $68, $1F
	dc.b	$64, $04, $6C, $1F, $70, $00, $78, $02, $74, $00, $7C, $03, $80, $12, $88, $05
	dc.b	$84, $13, $8C, $05, $83
loc_B9933:
	dc.b	$B0, $36, $B4, $C0, $30, $14, $38, $01, $34, $01, $3C, $02, $40, $18, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $8F, $58, $1F, $54, $1F, $5C, $14, $60, $1F, $68, $1F
	dc.b	$64, $0B, $6C, $3D, $70, $09, $78, $08, $74, $07, $7C, $00, $80, $04, $88, $04
	dc.b	$84, $04, $8C, $75, $83
loc_B9968:
	dc.b	$B0, $2C, $B4, $C0, $30, $70, $38, $74, $34, $32, $3C, $34, $40, $17, $48, $00
	dc.b	$44, $19, $4C, $05, $50, $19, $58, $14, $54, $19, $5C, $14, $60, $01, $68, $08
	dc.b	$64, $02, $6C, $05, $70, $01, $78, $01, $74, $02, $7C, $01, $80, $13, $88, $87
	dc.b	$84, $10, $8C, $37, $83
loc_B999D:
	dc.b	$B0, $24, $B4, $C0, $30, $70, $38, $74, $34, $31, $3C, $33, $40, $17, $48, $00
	dc.b	$44, $17, $4C, $00, $50, $19, $58, $14, $54, $19, $5C, $14, $60, $01, $68, $08
	dc.b	$64, $01, $6C, $08, $70, $01, $78, $01, $74, $01, $7C, $01, $80, $13, $88, $37
	dc.b	$84, $13, $8C, $37, $83
loc_B99D2:
	dc.b	$B0, $07, $B4, $C0, $30, $02, $38, $41, $34, $31, $3C, $60, $40, $00, $48, $00
	dc.b	$44, $00, $4C, $00, $50, $05, $58, $03, $54, $08, $5C, $09, $60, $03, $68, $05
	dc.b	$64, $05, $6C, $00, $80, $20, $88, $20, $84, $26, $8C, $06, $83
loc_B99FF:
	dc.b	$B0, $AA, $B4, $C0, $30, $52, $38, $31, $34, $31, $3C, $51, $40, $08, $48, $10
